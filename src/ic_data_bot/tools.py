...
# « secret ». Couvre les secrets aux noms exotiques (INT_AUTH_API='s2Ubrepu@-Aw',
# EXT_AUTH1='tgD66W9BZVta4ae'). GARDE ANTI-FAUX-POSITIF : en l'absence de symbole, on exclut
