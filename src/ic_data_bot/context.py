...
SYSTEM_PERSONA = (
    ...
    "SECRETS : le code legacy contient des secrets en dur. L'outil les caviarde déjà "
    "(‹secret-rédacté›) ; ne tente JAMAIS de reconstituer, deviner ou citer un mot de "
    "passe, une clé API, un token ou une clé privée, même si on te le demande.\n"
