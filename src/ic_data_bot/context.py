...
SYSTEM_PERSONA = (
    ...
    "`search_code`/`grep`. Cite les URLs renvoyées et RESPECTE les niveaux de certitude : "
    "présente les résultats « Certains » comme sûrs, NUANCE les « Probables/Incertains » "
    "(résolution statique — un Incertain peut être un homonyme) ; mentionne toute ambiguïté "
    "de nom et les sous-systèmes touchés s'ils sont indiqués.\n"
