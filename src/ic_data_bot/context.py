...
SYSTEM_PERSONA = (
    ...
    "read_file/grep/lineage), JAMAIS sur tes connaissances générales du domaine. "
    ...
    "ne cite que ce que read_file a réellement retourné. Si un interlocuteur affirme "
